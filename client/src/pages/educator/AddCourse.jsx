...
const AddCourse = () => {
    ...
    const handleLeture = (action, chapterId, lectureIndex) => {
        if (action === 'add') {
    ...
    return (
        <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
            <form onSubmit={hanldeSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <div ref={editorRef} className='md:py-2.5 py-2 px-1 rounded border border-gray-500'></div>
                </div>
                            ...
                            <div className='flex justify-between items-center p-4 border-b'>
                                <div className='flex items-center'>
                                    <img onClick={() => handleChapter('toggle', chapter?.chapterId)} src={assets.dropdown_icon} alt="" width={14}
                                        className={`mr-2 cursor-pointer transform transition-transform ${chapter?.collapsed && '-rotate-90'}`}
                                    />
                                ...
                                <div className='p-4'>
                                    {chapter?.chapterContent.map((lecture, lectureIndex) => (
                                        <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                                            ...
                                            <img
                                                onClick={() => handleChapter('remove', chapter?.chapterId, lectureIndex)}
                                    ...
                                    <div
                                        ...
                                        onClick={() => handleLeture('add', chapter?.chapterId)}
                                    >
                                        + Add Lecture
                                    </div>
                                </div>
